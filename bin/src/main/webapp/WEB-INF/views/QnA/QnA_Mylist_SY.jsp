						...
						<table class="table my-activities-table requests-table my-requests">
							<thead>
								<tr>
									...
									<th><a class="requests-link" href="/hc/ko/requests?sort_by=created_at&amp;sort_order=asc">등록일</a></th>
									<th>상태</th>
								</tr>
							</thead>
							<tbody>
								<c:forEach items="${list}" var ="qvo">
									<tr>
										...
										<td class="requests-table-status">
											<span class="status-label status-label-solved" title="답변을 확인해 주세요." style="background-color: ${qvo.processing_statu == 1 ? 'rgba(66, 65, 65, 1)' : ''}" >
													 ${qvo.processing_statu == 2 ? '답변완료' : '처리중'}
											</span>
										</td>
									</tr>
								</c:forEach> 
