...
<html>
	<head>
		...
		<link href="/css/admin/1_notice/Notice_Edit.css" rel="stylesheet" />
		
		<!-- 보고 필요없으면 지울거임 -->
		<!-- <script defer src="/js/admin/Notice_Edit.js"></script> -->
	</head>
		        ...
		        <main>
		            <div class="container-fluid px-4">
		                ...
		                <div class="card mb-4">
		                    ...
		                    <form action="/admin/1_notice/notice_write" method="post" id="frm" enctype="multipart/form-data">
		                        ...
		                        <div class="centerdiv">
		                            ...
		                            <p><span>내용</span></p>
		                            <p>
		                            	<textarea name="ntcText" id="ntcText"></textarea>
		                            </p>
		                            <!-- <p><span>버튼</span></p>
		                            <p>
		                            ...
		                            <p><span>링크</span></p>
		                            <p><input type="text" name="url_link" id="ntcBtnLink"></p>
		                        </div>
		                    </form>
		                    <div id="btn0">
		                        <button class='butn' id="btn1" onclick="updateBtn()">수정완료하기</button>
		                        <button class='butn' id="btn2" onclick="history.back()">수정취소하기</button>
		                    </div>
		                </div>
		            </div>
		        </main>
