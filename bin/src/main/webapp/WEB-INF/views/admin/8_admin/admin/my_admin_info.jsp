	    ...
	    <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                            ...
                            <div class="card-body">
                                ...
                                <table id="user-table" style="margin:0 auto;">
                                    <thead>
                                        ...
                                        <tr>
                                            <th>사원번호</th>
                                            <td id="user-type">1827457290</td>
                                        </tr>
                                        <tr>
                                            <th>관리자유형</th>
                                            <td id="user-ssn">일반관리자</td>
                                        </tr>
                                        <tr>
                                            <th>아이디</th>
                                            <td id="user-id">spring01</td>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
                    ...
                    <div id="button">
                    	<button type="button" onclick="location.href='/admin/8_admin/admin/my_admin_modify'">비밀번호 수정</button>
                    </div>
                </main>
            </div>
        </div>
