		            ...
		            <div class="container-fluid px-4">
		                ...
		                <div class="card">
		                    ...
		                    <div class="card-body">
		                        <div id="inputbox">
		                            &nbsp;&nbsp;&nbsp;기본정보
		                            <form action="" method="post" name="movInfo1">
			                            <div>
			                                <input type="text" name="movTitle" placeholder="표기할 영화제목" class="inBox1" id="movTitle" required/>
			                            </div>
			                            <div>
			                                <input type="text" name="movTitleOrg" placeholder="원제" class="inBox1" id="movTitleOrg"/>
			                            </div>
			                            <div>
			                                <input type="text" name="movMakingDate" placeholder="개봉 날짜 (YYYY-MM-DD)" value="" class="inBox1" id="movMakingDate" required/>
			                            </div>
			                            <div class="container" style="padding-right: 0px; padding-left: 0px; width: 95%; height: 50px; margin: 0 0 0 10px;">
				                            <select multiple="multiple" name="nation_list" id="nation_list" class="country" style="width: 100%; height: 50px; border: 1px solid rgb(255, 255, 255);">
			                            ...
			                            <div class="container" style="padding-right: 0px; padding-left: 0px; width: 95%; margin: 0 0 0 10px;">
			                                <select multiple="multiple" name="movGenre" id="movGenre" class="country" style=" width: 100%; height: 50px; border: 1px solid rgb(255, 255, 255);">
			                            ...
			                            <div>
			                                <input type="text" name="movTime" placeholder="상영시간(ex.1시간 20분 띄어쓰기해주세요)" class="inBox1" id="movTime"/>
			                            </div>
			                            <!-- 드롭다운 -->
			                            <div>
			                                <select name="age" name="movAge" class="inBox1" id="movAge" onchange="changeValue(this)">
		                            ...
		                            <div>
		                                &nbsp;&nbsp;&nbsp;출연/제작
	                            		<select name="job_select" class="inBox1" id="movJob">
	                            			<option value="" selected>직업군 선택</option>
	                            			<option value="감독">감독</option>
	                            			<option value="배우">배우</option>
	                            		</select>
	                            		<input type="text" name="person_name" placeholder="감독 or 배우 이름" class="inBox1">
		                            </div>
									
									<form action="" method="post" name="movInfo2">
			                            <div id="authorBox">
