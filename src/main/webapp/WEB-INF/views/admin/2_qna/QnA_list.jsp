		                    	...
		                    	<div class="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns">
		                    		<div class="datatable-top">
		                    			<div class="datatable-dropdown">
		                    				<form action="/admin/2_qna/QnA_list" method="get" name="datatableOption">
			                    				<label>
		                    			...
		                    			<form action="/admin/2_qna/QnA_list" method="get" name="QnASearch">
			                    			<div class="datatable-search">
			                    				<input type="search" name="searchWord" id="searchWord" class="datatable-input" placeholder="QnA 작성자로 검색" aria-controls="datatablesSimple" style="float:right;">
			                    			</div>
		                    			</form>
