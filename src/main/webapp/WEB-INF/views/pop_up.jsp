			...
			<div height="100%" class="css-2zu8pq">
				<div class="css-cdzmq7">
					<div class="css-iowq1w">
						<div class="css-iowq1w">
							<textarea maxlength="10000" placeholder="이 작품에 대한 생각을 자유롭게 표현해주세요." class="css-137vxyg"></textarea>
					...
					<div class="css-5d0dfn">
						<div data-type="twitter" class="css-hyoixq">
							<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none" class="css-7zhfhb">
								<path fill="#D4D4D4"
									d="M10.5942 24.625C19.5569 24.625 24.4581 17.3158 24.4581 10.9779C24.4581 10.7702 24.4538 10.5635 24.4441 10.3578C25.3955 9.68089 26.2225 8.83618 26.875 7.87439C26.0019 8.25611 25.0623 8.51346 24.0767 8.62942C25.0827 8.03579 25.8551 7.09616 26.2193 5.97624C25.2777 6.52563 24.2352 6.92522 23.1254 7.1404C22.2362 6.20815 20.9699 5.625 19.5686 5.625C16.8775 5.625 14.6952 7.77311 14.6952 10.4211C14.6952 10.7976 14.7381 11.1636 14.8216 11.5148C10.772 11.3144 7.18103 9.40568 4.778 6.50347C4.35914 7.21212 4.11813 8.03579 4.11813 8.91417C4.11813 10.5783 4.97836 12.0474 6.28641 12.9068C5.48727 12.8825 4.73629 12.6663 4.07956 12.3067C4.07842 12.3267 4.07842 12.3468 4.07842 12.3678C4.07842 14.6911 5.75831 16.6304 7.98767 17.0702C7.57851 17.1798 7.14778 17.2389 6.70318 17.2389C6.3893 17.2389 6.08397 17.2083 5.78719 17.1524C6.40754 19.058 8.20627 20.4447 10.3392 20.4838C8.6712 21.7703 6.57036 22.5369 4.28742 22.5369C3.89421 22.5369 3.50642 22.5149 3.125 22.4705C5.28159 23.8309 7.84203 24.625 10.5942 24.625Z">
								</path>
							</svg>
						</div>
					</div>
