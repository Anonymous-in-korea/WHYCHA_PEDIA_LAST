												...
												<div class="list_box4 BO" style="transform:translateX(0px)">
													<div class="list_box5">
														<ul class="list_box_ul" id="BO">
															...
															<c:forEach items="${starTop10List}" var="movie" varStatus="status">											
																<li class="list_box_li"> <!-- 10개  -->
																	<a title="${movie.movie_kor_title}" href="#">
																		<div class="list_box_poster">
																			<div class="list_box_poster2 ezcopuc0">
																				<img src="${movie.movie_post_url}" class="list_box_poster_image ezcopuc1">
																			</div>
																			<div class="list_box_number">${status.index + 1}</div>
																		</div>
																		<div class="list_box_info">
																			<div class="list_box_info_title">${movie.movie_kor_title}</div>
																			<div class="list_box_info_year"><fmt:formatDate value="${movie.movie_release_date}" pattern="yyyy"/></div>
																			...
																			<div class="list_box_info_per">누적 관객 ${movie.movie_total_audience}</div>
																		</div>
																	</a>
																</li>
															</c:forEach>
