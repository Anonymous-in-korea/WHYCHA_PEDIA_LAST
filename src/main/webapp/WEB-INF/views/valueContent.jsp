...
/*             undefined; */
    ...
    <link
            href="https://pedia.watcha.com/ko-KR/review"
            rel="canonical"
            data-rh="true"
    />
    <link
            ...
            data-rh="true"
    />
    <link href="/review" hreflang="en-US" rel="alternate" data-rh="true"/>
    <link
            href="/ja-JP/review"
            hreflang="ja-JP"
            rel="alternate"
            data-rh="true"
    />
    <link href="/review" hreflang="x-default" rel="alternate" data-rh="true"/>
    <!--                                                    -->
    <!--                                                    -->
    <!--                                                    -->
    <!--                  2145번째 줄부터                    -->
    <!-- 헤드 맨 끝 내가 새로 정의한 CSS효과 (중복체크 된 것) -->
    <style>

        .css-137vxyg::-webkit-scrollbar{
            display: none;
        }
        /* 평가하기 span 나타나기, 사라지기 */
        ...
        /* 평가준 영화 수, 이제 웬만한 친구보다 제가 당신을.... 영화, TV프로그램, 책... 고정위치 헤더 밑 */
        .css-cpl21l {
            position: fixed;
            top: 0px;
            z-index: 1;
        ...
        /* 719px이상부터 79, 이제 웬만한 친구보다 ... 영화, TV프로그램 ..., 랜덤 영화 버튼 큰박스를 중앙정렬 */
        @media (min-width: 719px) {
            .css-19oo7uc {
                max-width: 640px;
        ...
        /* 평가한 영화 수, 이제 웬만한 친구보다... 흰색으로 씌워주기 */
        .css-yatoeb-Self {
            background: rgb(255, 255, 255);
            height: 90px;
        }

        /* 719px이상부터 79, 이제 웬만한 친구보다 ... 영화, TV프로그램 ..., 랜덤 영화 버튼 큰박스 top마진 */
        @media (min-width: 719px) {
            .css-cpl21l {
                top: auto;
                padding: 28px 0px 0px;
        ...
        /* saction 패딩으로 79, 이제 웬만한 친구보다 ... 영화, TV프로그램 ..., 랜덤 영화 버튼 큰박스 top마진*/
        .css-18gwkcr {
            padding-top: 0px;
            padding-bottom: 56px;
        }
        ...
        /* 게시물들 박스내에서 좌우마진 20px */
        .css-1y901al-Row {
            margin: 0px 20px;
        }

        /*클릭된 영화, TV프로그램, 책, 웹툰 빨간색 강조*/
        .css-96eosw {
            display: inline-flex;
            -webkit-box-pack: center;
            justify-content: center;
        ...
        /* 반복되는 영화 평가 박스 큰 섹션 */
        .css-1ghnled-TabContentsContainer {
        ...
        /* 반복되는 영화리뷰 ul틀 */
        .css-1nukiuq-VisualUl-ReviewUl {
            padding-inline-start: 0px;
            margin-block-start: 0em;
            margin-block-end: 0em;
        }

        /*반복되는 영화리뷰 li 실질 내용물 (1개영화)*/
        .css-1pa5min {
            display: flex;
            align-items: flex-start;
            padding: 12px 0px;
        ...
        .css-1ajznjz-StyledLazyLoadingImage {
            position: relative;
            overflow: hidden;
            box-sizing: border-box;
        ...
        .css-dayhfn-StylelessButton-MoreButton {
            padding: 0px;
            border: none;
            margin: 0px;
            cursor: pointer;
            background: url(data:image/svg+xml;base64,) center center no-repeat;
            vertical-align: top;
            width: 24px;
            height: 24px;
        }
        ...
        .css-18l1qa.asg_visible {
            overflow: visible;
        }

        .css-fnwbjg.gray_star_hidden {
            visibility: hidden;
        }

        .css-fnwbjg.yellow_hidden {
            display: none;
        }
...
<!--    모달창 수정 -->
    <style>
        ...
        .css-166ww79-HeaderBarPrimitive-headerAddStyle {
            left: 0px;
            z-index: 50;
            background: rgb(255, 255, 255);
            font-size: 17px;
        ...
        .css-1iqwiov-ProfilePhotoImage {
            position: relative;
            z-index: 1;
            background: url(https://an2-glx.amz.wtchn.net/images/ex_aladin_logo_square.png) center center / cover no-repeat;
            width: 100%;
            height: 100%;
        }
        .css-1o6l6v7-ProfilePhotoImage {
            position: relative;
            z-index: 1;
            background: url(https://an2-glx.amz.wtchn.net/images/ex_yes24_logo_square.png) center center / cover no-repeat;
            width: 100%;
            height: 100%;
        }
        .css-q1d6gi-ProfilePhotoImage {
            position: relative;
            z-index: 1;
            background: url(https://an2-glx.amz.wtchn.net/images/ex_kyobo_logo_square.png) center center / cover no-repeat;
            width: 100%;
            height: 100%;
        }
        .css-pmfw5g-VisualUl-ExtraInfoUl {
            list-style: none;
            padding: 0px;
            margin: 20px 0px 0px;
        }
        ...
        .css-rh5flo-Introduce {
            ...
            line-height: 24px;
            margin: 8px 0px 25px;
        }.css-r6qxq2-ContentMetaInfoBlock {
             display: -webkit-box;
             display: -webkit-flex;
             display: -ms-flexbox;
             display: flex;
        ...
        .css-1fucs4t-StyledText {
            white-space: pre-wrap;
        }.css-5z8uft-StyledLazyLoadingImage {
             position: relative;
             overflow: hidden;
             display: block;
             position: relative;
        ...
        .css-1d7tft4-StylelessButton-HeaderCloseButtonSelf {
...
<!--    셀렉트 탭 -->
    <style>
        ...
        #tv-star, #book-star, #web-star {
            display: none;
        }
    </style>
    <script src="https://unpkg.com/vue@3"></script>
    <script defer src="/js/valueContent.js"></script>
    <script defer src="/js/valueContentVue.js"></script>
                        ...
                        <header class="css-yatoeb-Self e104qqaq0">
                            <div class="css-1gkas1x-Grid e1689zdh0">
                                <div class="css-1y901al-Row emmoxnt0">
                                    <h2 class="css-1kqxvpo-CountingHeader e104qqaq1" id="movie-star" th:text="${movieStar}">79</h2>
                                    <h2 class="css-1kqxvpo-CountingHeader e104qqaq1" id="tv-star" th:text="${tvStar}">79</h2>
                                    <h2 class="css-1kqxvpo-CountingHeader e104qqaq1" id="book-star" th:text="${bookStar}">79</h2>
                                    <h2 class="css-1kqxvpo-CountingHeader e104qqaq1" id="web-star" th:text="${webStar}">79</h2>
                                    <p class="css-j1g7kv-TextForCount e104qqaq2">
                                        이제 웬만한 친구보다 제가 당신을 더 잘 알걸요?
                                    </p>
                                </div>
                            </div>
                        </header>
<!--                        <form method="GET" id="select-type" target="param">-->
                                        ...
                                        <div class="css-1gkas1x-Grid e1689zdh0">
                                            <div class="css-1y901al-Row emmoxnt0">
                                                <ul class="css-lshjof-VisualUl">
                                                    <li class="css-96eosw" id="movie">영화</li>
                                                    <li class="css-kx8pjj" id="tv">TV 프로그램</li>
                                                    <li class="css-kx8pjj" id="book">책</li>
                                                    <li class="css-kx8pjj" id="webtoon">웹툰</li>
<!--                                                    <li class="css-96eosw" id="movie"><button onclick="typeChange('movie')">영화</button></li>-->
<!--                                                    <li class="css-kx8pjj" id="tv"><button onclick="typeChange('tv')">TV 프로그램</button></li>-->
<!--                                                    <li class="css-kx8pjj" id="book"><button onclick="typeChange('book')">책</button></li>-->
<!--                                                    <li class="css-kx8pjj" id="webtoon"><button onclick="typeChange('webtoon')">웹툰</button></li>-->
<!--                                                    <input type="hidden" name="contentType" value="movie"/>-->
<!--                                                    <script>-->
<!--                                                        function typeChange (data){-->
<!--                                                            document.querySelector("form#select-type input").value = data;-->
<!--                                                        }-->
<!--                                                    </script>-->
                                                </ul>
                                            </div>
                ...
                <section class="css-1ghnled-TabContentsContainer e1omr9iu1">
                    <div class="css-12hxjcc-StyledHideableBlock e1pww8ij0">
                        ...
                        <section class="css-vozok1-ContentsSection e1omr9iu2">
                            <div class="css-1gkas1x-Grid e1689zdh0">
                                <div class="css-1y901al-Row emmoxnt0">
                                    <ul class="css-1nukiuq-VisualUl-ReviewUl e1omr9iu4" id="content-ul">
                                        <li class="css-1pa5min content-li" v-for="content in itemList" :id="content.idx"
                                            :class="content.hasWish == true ? 'hasWish' : (content.hasWatch == true ? 'hasWatch' : '')">
                                            <div class="css-jy9y9j">
                                                <div
                                                        class="css-1ajznjz-StyledLazyLoadingImage ezcopuc0"
                                                >
                                                    <img
                                            ...
                                            <div class="css-1frtrxg">
                                                <h3 class="css-1a7e2fr">
                                                    {{content.title}}
<!--                                                    영화제목-->
                                                </h3>
                                                <div class="css-rrfi5z">
                                                    <button
                                                            class="css-dayhfn-StylelessButton-MoreButton e1hc1f3f0"
                                                    ></button>
                                                </div>
                                                <div class="css-tr3vhx">
                                                    {{content.makingDate}} ・ {{content.country}}
<!--                                                    제작연도 ・ 나라-->
                                                </div>
                                            ...
                                            <div class="comment-hidden" :class="content.commSpo == true?'hasSpo': ''" :id="content.comment != null ? content.comment.commIdx : ''">{{content.comment !=null ? content.comment.commText: ''}}</div>
                                        </li>

                                    </ul>
                                    <div
                                            class="e1omr9iu0 css-z4jx26-StyledInfinityScroll-InfinityScroll eu826xw0"
                                    ></div>
                                </div>
                            </div>
                        </section>
                        ...
                        <div height="100%" class="css-2zu8pq">
                            <div class="css-cdzmq7">
                                <div class="css-iowq1w">
                                    <div class="css-iowq1w"><textarea maxlength="10000" placeholder="이 작품에 대한 생각을 자유롭게 표현해주세요." class="css-137vxyg"></textarea>
                                    </div>
                                </div>
                            </div>
