<%@ page language="java" contentType="text/html; charset=UTF-8"
						...
						<div class="css-blhbko">
							<div class="css-1gkas1x-Grid e1689zdh0">
								<div class="css-1y901al-Row emmoxnt0">
									<div class="css-l84u8">
										<span
											src="images/wishWatching.png"
											class="css-ntv7u"></span>
									</div>
									<div class="css-1q1aaw9">내 보관함에 작품을 담으려면 로그인이 필요
										해요.회원가입 혹은 로그인해주세요.</div>
								</div>
							</div>
						</div>
	...
	<!--코멘트 팝업창 시작 --> 
	<div class="css-comment_popUp" style="display:none">
		<div id="modal-container-_UXspPLNadvpHIg80kJol" class="css-rpyl6s">
			<div class="css-ikkedy">
				<header title="" class="css-155l1de-HeaderBarPrimitive">
					<div class="css-19pxr9t">
	...
	<!--코멘트 팝업창 끝  --> 
		<!--보는중 팝업창 시작 --> 
	<div class="css-looking_popUp" style="display:none">
		<div id="modal-container-_UXspPLNadvpHIg80kJol" class="css-rpyl6s">
			<div class="css-ikkedy">
				<header title="" class="css-155l1de-HeaderBarPrimitive">
					<div class="css-19pxr9t">
						...
						<div class="css-blhbko">
							<div class="css-1gkas1x-Grid e1689zdh0">
								<div class="css-1y901al-Row emmoxnt0">
									...
									<div class="css-1q1aaw9">로그인이 필요한 기능이에요. 
									지금 회원가입 혹은 로그인을 하셔서 
									영화를 당신의 콜렉션에 담아보세요</div>
								</div>
							</div>
						</div>
						<div class="css-y06mto">
