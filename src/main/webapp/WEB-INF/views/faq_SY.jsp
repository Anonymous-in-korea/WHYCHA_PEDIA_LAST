	...
	<body class="">
	                ...
	                <section class="categories blocks">
	                    <ul class="blocks-list">
	                        <li class="blocks-item">
	                            <a href="/hc/ko/categories/900000097023-%EC%84%9C%EB%B9%84%EC%8A%A4-%EC%A3%BC%EC%9A%94-%EC%95%88%EB%82%B4" class="blocks-item-link">
	                                <span class="blocks-item-title">문의 내역</span>
	                                <span class="blocks-item-description"></span>
	                            </a>
	                        </li>
	                        <li class="blocks-item">
	                            <a href="/hc/ko/categories/900000097043-FAQ" class="blocks-item-link">
	    ...
	    <footer style="top: 170px; padding-left: 20px;" class="css-wvwa3p">
	        <div class="foo">
	            ...
	            <ul class="css-37p0v">
	                <li class="css-thfupn">
	                    <span class="css-uw7vnf">왓챠피디아 광고 문의</span>
