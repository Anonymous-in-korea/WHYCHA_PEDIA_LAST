...
<div class="comment_reply_popUp" style="display:none;">
	<div id="modal-container-LCVk3ztPTTC2hR1ZGfU_b" class="css-rpyl6s">
		<div class="css-1p257d1-modalAddStyle">
				...
				<div height="100%" class="css-2zu8pq">
					<div class="css-cdzmq7">
						<div class="css-iowq1w">
							<form action="" method="get" name="myCommentReplyModify">
							<input type="hidden" name="userId" value="${ myCommentVo.user_id }">
							<input type="hidden" name="movieId" value="${ movieVo.id }">
							<div class="css-iowq1w">
								<textarea name="reply_content" id="reply_write" maxlength="1000" placeholder="댓글을 작성해주세요.(1000 글자이내)" class="css-137vxyg">${ myCommentVo.comment_content }</textarea>
							</div>
							</form>
						</div>
					</div>
			...
			<div class="css-183vuuo comment_reply_box2">
...
<!-- 댓글 수정하기 팝업창 >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> -->
<div class="comment_modify_popUp" style="display:none;">
	<div id="modal-container-LCVk3ztPTTC2hR1ZGfU_b" class="css-rpyl6s">
		<div class="css-1p257d1-modalAddStyle">
			<header title="" class="css-166ww79-HeaderBarPrimitive-headerAddStyle">
				<div class="css-19pxr9t"></div>
				<em class="css-10mjbgt">댓글 수정하기</em>
				<div class="css-19pxr9t">
					<button class="css-1lvet1d-StylelessButton"></button>
				</div>
			</header>
			<div class="css-1iv0iqc comment_modify_pop_up_inside">
				<div height="100%" class="css-2zu8pq">
					<div class="css-cdzmq7">
						<div class="css-iowq1w">
							<form action="" method="get" name="myCommentReplyModify">
							<input type="hidden" name="userId" value="${ myReply.user_id }">
							<input type="hidden" name="movieId" value="${ movieVo.id }">
							<div class="css-iowq1w">
								<textarea name="reply_modify_content" id="reply_modify" maxlength="1000" placeholder="댓글을 작성해주세요.(1000 글자이내)" class="css-137vxyg">${ myReply.reply_content }</textarea>
							</div>
							</form>
						</div>
					</div>
			...
			<div class="css-183vuuo comment_modify_box2">
				<div class="css-a2jbfo">
					<div class="css-6qnjre">
						<div class="css-5d0dfn">
							<div data-type="twitter" class="css-hyoixq">
					...
					<div class="css-6qnjre">
						<p class="css-1s08rlk"></p>
						<button type="button" id="comment_modify_input" class="css-1ukikc-StylelessButton">수정</button>
					</div>
				</div>
			</div>
		</div>
