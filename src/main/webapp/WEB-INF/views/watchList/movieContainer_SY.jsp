...
<html>
	 <head>
	   		<title th:text="'왓챠피디아 - '+${memberVo.user_name}+'의 영화 보관함'">보고싶어요2</title>
		      <!-- 필요한 CSS, JS 로드 -->
										...
										<div class="css-1gkas1x-Grid e1689zdh0">
											<div class="css-1y901al-Row emmoxnt0">
												<header class="css-1ue9xs6">
													...
													<span class="css-wzn7fp">${starRateListSize}</span>
													<div class="css-s289sk">
														<div class="css-1ugqy9j">
															<a id="more-btn" href="/watchList/rated_SY?user_id=${memberVo.id}">더보기</a>
														</div>
													</div>
												</header>
											</div>
											...
											<!-- 하단 보고싶어요 보는 중 div 리스트   -->
													...
													<li class="css-17543n0">
														<div class="css-11axhrb">
															<div class="css-1ciqeix">
																<a class="css-1j6t0vk-StylelessLocalLink-ArchivesActionListLink ei8r22x2" href="/watchList/wishWatch_SY?user_id=${memberVo.id}">
																보고싶어요
																<span class="css-1vam9en-ArchivesByActionCount ei8r22x1">${wishWatchListSize}</span></a>
															</div>
															<div class="css-0"></div>
														</div>
													</li>
												...
												<!-- 보는중 리스트 시작   -->
													<li class="css-17543n0">
														<div class="css-11axhrb">
															<div class="css-1ciqeix">
																<a class="css-1j6t0vk-StylelessLocalLink-ArchivesActionListLink ei8r22x2" href="/watchList/watching_SY?user_id=${memberVo.id}">
																	보는중
																	<span class="css-1vam9en-ArchivesByActionCount ei8r22x1">${watchingListSize}</span>
																</a>
															</div>
															<div class="css-0"></div>
														</div>
