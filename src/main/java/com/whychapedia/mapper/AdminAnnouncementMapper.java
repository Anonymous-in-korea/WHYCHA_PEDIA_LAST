...
public interface AdminAnnouncementMapper {
	...
	public List<AnnouncementVo> adminAnnouncementListAll(int startRow, int endRow);
	public List<AnnouncementVo> adminAnnouncementListAll_searchWord(int startRow, int endRow, String searchWord);
